...
export default function ReactComponent({
  ...
  return (
    <div className="relative pt-36 sm:pt-56 overflow-hidden" ref={container}>
      ...
      <div className="hidden sm:flex absolute scale-[1.7] desktop:scale-[1.5] 2xl:scale-100 top-[220vh] md:top-[155vh] desktop:top-[165vh] 2xl:top-[80vh] -right-40 md:-right-20 desktop:-right-12 w-1/4 desktop:w-1/5 uhd:w-1/6 ">
        <motion.img
          style={{ y: lg }}
      ...
      <motion.div
        ...
        className="absolute top-[70vh] right-[100vw] sm:top-40 sm:right-32 -z-10"
      >
        <Lottie
