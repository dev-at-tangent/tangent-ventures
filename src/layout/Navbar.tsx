...
export default function Navbar({ currentPath }: { currentPath: string }) {
  return (
    <div className="sticky z-10 top-4 flex items-center justify-evenly text-sm font-medium gap-x-1 w-full rounded-full backdrop-blur-lg bg-white/60 px-4 py-2">
      <a href="/">
        <img src={Logo.src} />
      </a>
      <div className="grow" />
